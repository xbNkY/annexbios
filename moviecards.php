<d?php include('./core/header.php'); include "core\php\datafetch.php" ; $movies=getMovies(); //dumpt alle array data
   overzichtelijk // echo "<pre>" ; // var_dump( $movies); // echo "</pre>" ; // //foreach die door de array loopt en
   data in beeld toont // if (is_array($movies["data"])) { // foreach ($movies["data"] as $key=> $item) {
   // // echo "Item $key:<br>";
